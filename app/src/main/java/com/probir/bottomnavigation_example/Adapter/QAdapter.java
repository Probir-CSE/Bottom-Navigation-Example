...
import com.probir.bottomnavigation_example.MainActivity;
...
public class QAdapter extends RecyclerView.Adapter<QAdapter.MYViewHolder> {
    ...
    public QAdapter(QModel[] qModels) {
...
//        holder.cardView.setBackground(qModels[position].getCardView().getBackground());
        ...
        holder.RV_mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "" + qModel.getSubjectName(), Toast.LENGTH_SHORT).show();
                Context context=v.getContext();
                Intent intent = new Intent(context, PlayerDetailsActivity.class);
                intent.putExtra( "name",qModel.getSubjectName());
